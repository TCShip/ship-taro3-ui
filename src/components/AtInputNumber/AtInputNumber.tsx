...
export default class AtInputNumber extends AtComponent<AtInputNumberProps> {
    ...
    onInput = event => this.props.onChange(event.target.value)

    onFocus = event => this.props.onFocus && this.props.onFocus(event.target.value, event)
    ...
    onConfirm = event => this.props.onConfirm && this.props.onConfirm(event.target.value)
  
    onClick = (e) => !this.props.editable && this.props.onClick && this.props.onClick(e)
  
    clearValue = (e) => this.props.onChange && this.props.onChange(e.target.value)
  
    onErrorClick = (e) => this.props.onErrorClick && this.props.onErrorClick(e)
    
    handleClick (clickType) {
        const { disabled, value, min=0, max=0, step=0 } = this.props
    ...
    handleBlur = (e) => this.props.onBlur && this.props.onBlur(e)
